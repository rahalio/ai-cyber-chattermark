...
export const ZodSigId = createDomainIdValidator('sig', 'Signal ID');
export const ZodSrcId = createDomainIdValidator('src', 'Source ID');
export const ZodFctId = createDomainIdValidator('fct', 'Forecast ID');
export const ZodEstId = createDomainIdValidator('est', 'Estate ID');
export const ZodWrnId = createDomainIdValidator('wrn', 'Warning ID');
export const ZodDecId = createDomainIdValidator('dec', 'Decision ID');
export const ZodAsrId = createDomainIdValidator('asr', 'Assurance ID');
export const ZodGovId = createDomainIdValidator('gov', 'Governance ID');
