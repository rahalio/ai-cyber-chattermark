/**
 * Warnings Services - Application Layer Export
 *
...
/**
 * Warnings Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for warnings domain.
 */
