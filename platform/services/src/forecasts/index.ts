/**
 * Forecasts Services - Application Layer Export
 *
...
/**
 * Forecasts Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for forecasts domain.
 */
