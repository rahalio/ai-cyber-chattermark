/**
 * Signals Services - Application Layer Export
 *
...
/**
 * Signals Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for signals domain.
 */
