...
import { DynamoDbOutboxStore } from "@chattermark/adapters/_shared/messaging/dynamodb-outbox-store.js";
import { startOutboxWorker } from "@chattermark/adapters/_shared/messaging/outbox-worker.js";
import { createInProcessIntegrationEventBus } from "@chattermark/adapters/_shared/messaging/in-process-integration-event-bus.js";
