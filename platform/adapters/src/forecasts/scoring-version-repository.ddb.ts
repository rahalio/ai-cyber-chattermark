/**
 * ScoringVersionRepository - DynamoDB Implementation
 *
...
/**
 * ScoringVersionRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing ScoringVersion repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { ScoringVersionRepository } from "@chattermark/services/forecasts";
...
/**
 * ScoringVersionRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: SCORING_VERSION
 * Entity Token: SCORING_VERSION
 * SK Prefix: SCORING_VERSION
 */
export class ScoringVersionRepositoryDdb implements ScoringVersionRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "SCORING_VERSION";
  private readonly ENTITY_TOKEN = "SCORING_VERSION";
  private readonly SK_PREFIX = "SCORING_VERSION";
  ...
  private readonly ENTITY_TYPE_PK = "SCORING_VERSIONS";
