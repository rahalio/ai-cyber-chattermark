/**
 * AuditEventRepository - DynamoDB Implementation
 *
...
/**
 * AuditEventRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing AuditEvent repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { AuditEventRepository } from "@chattermark/services/governance";
...
/**
 * AuditEventRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: AUDIT_EVENT
 * Entity Token: AUDIT_EVENT
 * SK Prefix: AUDIT_EVENT
 */
export class AuditEventRepositoryDdb implements AuditEventRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "AUDIT_EVENT";
  private readonly ENTITY_TOKEN = "AUDIT_EVENT";
  private readonly SK_PREFIX = "AUDIT_EVENT";
  ...
  private readonly ENTITY_TYPE_PK = "AUDIT_EVENTS";
