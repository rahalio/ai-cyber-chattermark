/**
 * WarningRepository - DynamoDB Implementation
 *
...
/**
 * WarningRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing Warning repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { WarningRepository } from "@chattermark/services/warnings";
...
/**
 * WarningRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: WARNING
 * Entity Token: WARNING
 * SK Prefix: WARNING
 */
export class WarningRepositoryDdb implements WarningRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "WARNING";
  private readonly ENTITY_TOKEN = "WARNING";
  private readonly SK_PREFIX = "WARNING";
  ...
  private readonly DOMAIN = "WARNINGS";
  private readonly ENTITY_TYPE_PK = "WARNINGS";
  private generateCorrelationId(): string {
    const domainPrefix = "wrn";
