 ...
 *
 * DDD: Infrastructure adapter implementing Backtest repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { BacktestRepository } from "@chattermark/services/assurance";
...
/**
 * BacktestRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: BACKTEST
 * Entity Token: BACKTEST
 * SK Prefix: BACKTEST
 */
export class BacktestRepositoryDdb implements BacktestRepository {
  ...
  private readonly ENTITY_TYPE = "BACKTEST";
  private readonly ENTITY_TOKEN = "BACKTEST";
  private readonly SK_PREFIX = "BACKTEST";
  ...
  private readonly ENTITY_TYPE_PK = "BACKTESTS";
