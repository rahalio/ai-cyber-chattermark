...
import type { DecisionRepository } from "@chattermark/services/decisions";
...
export class DecisionRepositoryDdb implements DecisionRepository {
  ...
  private readonly ENTITY_TYPE = "DECISION";
  private readonly ENTITY_TOKEN = "DECISION";
  private readonly SK_PREFIX = "DECISION";
  ...
  private readonly DOMAIN = "DECISIONS";
  private readonly ENTITY_TYPE_PK = "DECISIONS";
  private generateCorrelationId(): string {
    const domainPrefix = "dec";
  ...
  async createDecision(input: Parameters<DecisionRepository['createDecision']>[0]): Promise<Awaited<ReturnType<DecisionRepository['createDecision']>>> {
