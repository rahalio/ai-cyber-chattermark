/**
 * SourceRepository - DynamoDB Implementation
 *
 ...
 * SourceRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing Source repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { SourceRepository } from "@chattermark/services/sources";
...
/**
 * SourceRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: SOURCE
 * Entity Token: SOURCE
 * SK Prefix: SOURCE
 */
export class SourceRepositoryDdb implements SourceRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "SOURCE";
  private readonly ENTITY_TOKEN = "SOURCE";
  private readonly SK_PREFIX = "SOURCE";
  ...
  private readonly ENTITY_TYPE_PK = "SOURCES";
