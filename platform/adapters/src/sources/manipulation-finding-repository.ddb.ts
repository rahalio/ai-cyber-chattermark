/**
 * ManipulationFindingRepository - DynamoDB Implementation
 *
...
/**
 * ManipulationFindingRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing ManipulationFinding repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { ManipulationFindingRepository } from "@chattermark/services/sources";
...
/**
 * ManipulationFindingRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: MANIPULATION_FINDING
 * Entity Token: MANIPULATION_FINDING
 * SK Prefix: MANIPULATION_FINDING
 */
export class ManipulationFindingRepositoryDdb implements ManipulationFindingRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "MANIPULATION_FINDING";
  private readonly ENTITY_TOKEN = "MANIPULATION_FINDING";
  private readonly SK_PREFIX = "MANIPULATION_FINDING";
  ...
  private readonly ENTITY_TYPE_PK = "MANIPULATION_FINDINGS";
